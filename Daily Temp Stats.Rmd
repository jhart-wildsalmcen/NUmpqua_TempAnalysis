...
```{r}
temp <- water_master %>% 
  filter(logger_id == "21433141" & longdate > '2024-06-19') 
  

plot_21433131 <- ggplot() +
  ...
  theme_bw()+
  labs(title= "N. Umpqua Above Steamboat Cr.", y="Temperature (°C)", x="Date")

plot_21433131

# Change file name 
ggsave(file="2024 Logger Sites/Daily Plots/plot_2143313122.png", height = 7, width = 15)
```
