...
a <- ggplot(airwater_join, aes(x=air_max, y = water_max)) +
  ...
  theme_light() + 
 labs(title="N.Umpqua Above Steamboat",
...
ggsave("2024 Logger Sites/Water/Regression Plots/Max Daily/N.Umpqua Above Steamboat.png", width = 10, height = 7)
```
...
```{r}
# Export regression plot
ggsave("2024 Logger Sites/Water/Regression Plots/Mean Daily/N.Umpqua Above Steamboat.png", width = 10, height = 7)
```
