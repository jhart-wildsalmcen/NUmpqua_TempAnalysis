...
plot_21433141<- ggplot() +
  geom_line(data=temp, aes(x=as.Date(longdate),y=mean_temp, color="mean_temp"), linewidth =.75) +
  ...
  scale_y_continuous(limits = c(9,27), breaks = seq(10,26,by=4)) +
  theme_bw()+
  theme(legend.position = "none") +
  labs(title= "N. Umpqua Above Steamboat Cr.", subtitle = temp$coordinates, y="Temperature (°C)", x="Date") 
  #theme(plot.subtitle = element_text(size = 10))

plot_21433141

# Change file name 
ggsave(file="2024 Logger Sites/Water/Daily Plots/plot_21433145.png", height = 6, width = 10)
```

```{r}
temp <- water_master %>% 
  filter(logger_id == "21433145" & longdate > '2024-06-19' & longdate <= '2024-09-15') 


plot_21433145<- ggplot() +
  ...
  theme_bw()+
  theme(legend.position = "none") +
  labs(title= "N. Umpqua below Steamboat Cr.", subtitle = temp$coordinates, y="Temperature (°C)", x="Date") 
  #theme(plot.subtitle = element_text(size = 10))
